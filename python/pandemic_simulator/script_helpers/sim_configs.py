...
above_medium_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(Airport, num=2, num_assignees=20, state_opts=dict(visitor_capacity=200))
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
...
medium_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(Airport, num=1, num_assignees=15, state_opts=dict(visitor_capacity=150))
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
...
small_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        # Small town airport numbers
        LocationConfig(Airport, num=1, num_assignees=10, state_opts=dict(visitor_capacity=100))
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
...
tiny_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        # Tiny town airport numbers
        LocationConfig(Airport, num=1, num_assignees=5, state_opts=dict(visitor_capacity=50))
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
...
test_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        # Test airport numbers
        LocationConfig(Airport, num=1, num_assignees=3, state_opts=dict(visitor_capacity=30))
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
